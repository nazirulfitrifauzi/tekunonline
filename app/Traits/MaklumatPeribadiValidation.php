...
trait MaklumatPeribadiValidation
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'bank1_register_bank_no' => 'required|alpha_num',
    ...
    protected $messages = [
        ...
        'bank1_register_bank_no.required' => 'Sila masukkan nombor pendaftaran bank',
        'bank1_register_bank_no.alpha_num' => 'Nombor pendaftaran bank mestilah nombor dan huruf sahaja',
