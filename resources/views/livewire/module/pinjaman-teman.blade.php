<div>
        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Sokongan Kumpulan</h3>
                </div>
            </div>
                ...
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="duration_intro_team" class="block text-sm font-medium leading-5 text-gray-700">Tempoh Perkenalan Pemohon Dengan Kumpulan<span class="text-red-700">*</span></label>
                                <select id="duration_intro_team" name="duration_intro_team" class="block px-3 py-2 mt-1 w-full bg-white rounded-md border border-gray-300 shadow-sm transition duration-150 ease-in-out form-select focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5" wire:model.live="duration_intro_team">
                                    ...
                                    <option value="10-20 TAHUN">10-20 TAHUN</option>
                            ...
                            <div class="col-span-6 sm:col-span-2">
                                ...
                                <x-datetime-picker label="Tarikh Perbincangan Kumpulan" id="discussion_date"
                                    placeholder="Tarikh Perbincangan" without-time wire:model="discussion_date"/>
                            ...
                            <div class="col-span-6 sm:col-span-2">
                                ...
                                <input id="supported_fin_amount" name="supported_fin_amount" value="" class="block px-3 py-2 mt-1 w-full rounded-md border border-gray-300 shadow-sm transition duration-150 ease-in-out form-input focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5" wire:model.live="supported_fin_amount">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="">
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Pengesahan Dan Perakuan</h3>
                </div>
            </div>
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-2">
                                ...
                                <input id="group_leader_phone" name="group_leader_phone" value="" class="block px-3 py-2 mt-1 w-full rounded-md border border-gray-300 shadow-sm transition duration-150 ease-in-out form-input focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5" wire:model.live="group_leader_phone">                               
                            </div>
                        </div>
                    </div>
                </div>
